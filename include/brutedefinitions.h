...
// Meaning of entries: starttime, endtime, duration, pitch, velocity, panX
typedef std::tuple< int64_t, int64_t, int64_t, int32_t, int32_t, float > ToneTuple;
    ...
    /* Pianos  0 - 8 */  3,4,5,6,17,7,19,2, /* Chromatic Percussion 9-16 */ 1,1,1,1,1,1,1,1, /* Organ  17-24   */ 4,4,4,6,6,6,6,6,
    ...
    /* Pipe     73-80*/  5,5,5,5,5,5,5,5, /* Synth Lead 81-88          */ 4,3,4,4,4,4,4,0, /* Synth Pad 89-96*/ 19,5,5,5,5,4,5,5,
